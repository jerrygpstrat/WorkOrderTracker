...
{
    /// <inheritdoc />
    public partial class InitialWOEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LaborLogs_Technicians_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "Technicians",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LaborLogs_WorkOrders_WorkOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtTimeOfUse = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LaborLogs_TechnicianId",
                table: "LaborLogs",
                column: "TechnicianId");

            migrationBuilder.CreateIndex(
                name: "IX_LaborLogs_WorkOrderId",
                table: "LaborLogs",
                column: "WorkOrderId");
